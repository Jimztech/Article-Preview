document.addEventListener('DOMContentLoaded', function() {
    ...
    const originalSubFooter = subFooter.innerHTML;
    ...
    function showHoveringFooter () {
        subFooter.innerHTML = `
            <div class="hovering-footer">
                ...
                <button class="share-icon" id="share-icon-hovering">
                <img 
        ...
        document.getElementById('share-icon-hovering').addEventListener('click', showSubFooter);
    }
    

    function showSubFooter() {
        subFooter.innerHTML = originalSubFooter;
        document.getElementById('share-icon').addEventListener('click', showHoveringFooter);
    }
    document.getElementById('share-icon').addEventListener('click', showHoveringFooter);
});